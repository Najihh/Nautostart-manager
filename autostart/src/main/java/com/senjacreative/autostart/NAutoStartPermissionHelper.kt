package com.senjacreative.autostart
...
class NAutoStartPermissionHelper private constructor() {
    ...
    companion object {
        @JvmStatic
        fun getInstance(): NAutoStartPermissionHelper {
            return NAutoStartPermissionHelper()
        }
